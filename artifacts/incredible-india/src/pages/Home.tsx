    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 text-center flex-1 flex flex-col justify-center w-full">
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            <div
              className="h-px w-24"
              style={{ backgroundColor: HERO_RED, opacity: 0.7 }}
            />
          ...
          >
            Explore the rich cultural heritage, ancient traditions, vibrant
            festivals, and timeless wisdom of every state and union territory of
            India.
          </p>
            ...
            {[
              ...
              <div key={s.label} className="flex items-center gap-8">
                <div className="text-center">
                  ...
                  <div className="text-sm mt-1 font-bold">{s.label}</div>
                </div>
                {i < arr.length - 1 && (
                  <div
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <section className="mt-20 text-center">
          ...
          >
            "India is not a country. It is an experience — a civilization that
            breathes through its art, music, dance, cuisine, festivals, and the
            wisdom passed down through millennia. This platform exists to ensure
            that every thread of this magnificent tapestry is seen, known, and
            celebrated."
          </p>
        ...
        <section className="mt-16">
          ...
          >
            <p style={{ textAlign: "justify" }}>
              ...
              harat. Hindustan. India. Three names, one civilisation — the
              oldest continuous culture on Earth. The name 'Bharat', enshrined
              in the Constitution, is traced to the ancient king Bharata of the
              Rigveda, after whom this land came to be called Bhāratavarṣa —
              'the country of Bharata'. Across 3.28 million square kilometres,
              India unfolds as a subcontinent of astonishing variety: from the
              snow-capped Himalayas to the coral atolls of Lakshadweep, from the
              Thar desert to the rain-drenched hills of Meghalaya. Twenty-two
              official languages, over 1,600 mother tongues and every major
              world religion find their home here, giving India its unrivalled
              cultural diversity.
            </p>

            <p style={{ textAlign: "justify" }}>
              For nearly two centuries, the subcontinent was ruled by the
              British Crown. The Raj (1858–1947) drew railways and universities
              but also drained wealth, redrew boundaries and left behind scars
              that still shape modern India. Against this empire rose an
              extraordinary generation — Gandhi, Tagore, Ambedkar, Bose, Nehru —
              whose non-violent freedom movement, culminating on 15 August 1947,
              remains one of the 20th century's defining moral victories.
            </p>

            <p style={{ textAlign: "justify" }}>
              Today, India stands as the world's most populous democracy and a
              rising technological and scientific power. It is the birthplace of
              zero, yoga, Ayurveda, chess and decimal mathematics; home to
              Bollywood, the IT revolution and a thriving space programme that
              landed Chandrayaan at the lunar south pole. India contributes to
              global medicine, software, spirituality, cinema and cuisine — all
              while guarding a living heritage over five thousand years old.
              Explore the map below to begin a journey through its twenty-eight
              states and eight union territories.
            </p>
          </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-10 text-center">
          ...
          <p
            ...
            style={{ color: GOLD_SOFT, opacity: 0.85 }}
          >
            A cultural preservation initiative celebrating the diversity,
            heritage, and living traditions of India's 28 states and 8 union
            territories.
          </p>
          <div
            className="mt-6 text-xs"
            style={{ color: GOLD_SOFT, opacity: 0.6 }}
          >
